...
import disms.SISStore.client2.ClientBackup;
...
//        SISSERVER.out.println(returnInfo);
	...
	public void getFileInfo(){
		...
		newName = file_UUID.toString()+'.'+getInfoList[0];
	}
	public void getFile() throws IOException{
		File createFile = new File(tempPath);
		if(!createFile.exists())
			createFile.createNewFile();		
		new FileUtil().copyFileToDir(tempPath,fileObj,newName);
//		try {
...
//		System.out.println("into sendInfo");
	...
	public ServerBackup(String command,String ID,String time,File file) throws Exception{
//		this.socket= socket; 	   
//		serSocket = new ServerSocket(10000);
		fileInfoPath = org.opendedup.sdfs.Main.volume.getPath()+"\\files\\";
		fileObj = file;
		...
		if(getInfo != null){
			...
			ClientBackup.receiveInfo=returnInfo.split("[*]");
//			sendInfo();
		}
		else
		{
