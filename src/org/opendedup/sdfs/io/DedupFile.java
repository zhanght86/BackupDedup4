...
public interface DedupFile {
	 ...
	 * Writes all the cache buffers to the dedup chunk store service
	 */
	public abstract int writeCache(String guid,int blocknum) throws IOException, HashtableFullException;
	 ...
	 * */
	public abstract int getChunkLen(long pos,int blocknum);
	/*
	 * @param dfguid
	 * 			the GUID of dedup file 
	 * @param return
	 *          the raw chunk of the dedupfile from the berkeley DB 
	 * */
	public abstract byte[] getFSPRAWLChunk(String dfguid);
	 ...
	 *          the raw chunk of the dedupfile from the berkeley DB 
	 * */
	public abstract byte[] getCDCRAWLChunk(String dfguid);
	/**
	 * 
	 * @param position
	 ...
	 *            retrieved from
	 * @param buflen
	 *            the size of writebuffer.
	 * @param blocknum
	 * 			  the number of cdcchunk(writebuffer) in the dedup file.
	 * @return the write buffer for the give position
	 * @throws IOException
	 */
	public abstract WritableCacheBuffer getCDCWriteBuffer(long position,int buflen,int blocknum,
	 ...
	 * @throws IOException
	 */
//	public abstract DedupChunk getCDCReadBuffer(long position,int chunklen,int blocknum) throws IOException;

	public abstract DedupChunk getCDCChunkReadBuffer(long position,int chunklen,byte[]sparsecdcdatachunk,int blocknum) throws IOException;
	
	public abstract DedupChunk getCDCChunkReadBuffer(long position,int chunklen,int blocknum) throws IOException;
	
	public abstract DedupChunk getFSPChunkReadBuffer(long position,int chunklen,byte[]sparsefspdatachunk,int blocknum) throws IOException, FileClosedException;
