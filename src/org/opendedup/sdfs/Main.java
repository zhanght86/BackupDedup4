...
public class Main {
	...
	public static String backuplogPath = "/var/log/backupdedup/backup.log";
	
	public static String restorelogPath = "/var/log/backupdedup/restore.log";
	
	public static String runstatelogPath = "/var/log/backupdedup/runstate.log";
	...
	public static boolean iscdc=false;//content-defined chunking
	public static boolean issis=false;//shingle instance storage
	public static boolean issw=false;// sliding window chunking
	public static boolean issdfs=false;//sdfs fixed-sized chunking 
	public static boolean isfsp=false;//fsp
