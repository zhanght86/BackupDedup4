...
public class NewMgmtWebServer implements Container {
	private  Connection connection = null;
	private  String archivePath = new File(Main.volume.getPath()).getParent() + File.separator + "archives";
	...
	public  void start() {
		if (Main.sdfsCliEnabled) {
			try {
				Container container = new NewMgmtWebServer();
