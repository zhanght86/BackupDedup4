...
public interface AbstractHashesMap {
	...
	public abstract boolean preput(ChunkData cm) throws IOException,
	HashtableFullException;
	
	public abstract boolean put(ChunkData cm, boolean persist)
			throws IOException, HashtableFullException;
	
	public abstract boolean preput(ChunkData cm, boolean persist)
	throws IOException, HashtableFullException;
	...
	public abstract byte[] getData(byte[] key,int chunklen) throws IOException;
